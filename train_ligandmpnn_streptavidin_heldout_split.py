...
from LASErMPNN.utils.pdb_dataset_ligandmpnn import UnclusteredProteinChainDataset, ClusteredDatasetSampler, collate_sampler_data, BatchData, invert_dict, chain_list_to_protein_chain_dict
...
if __name__ == "__main__":
    ...
    params = {
        ...
        'output_weights_checkpoint_prefix': CURR_FILE_DIR_PATH / 'model_weights/streptavidin_heldout_split',
